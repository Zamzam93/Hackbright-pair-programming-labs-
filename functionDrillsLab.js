...
const printName = (personName) =>{
    console.log(`${personName} would be console logged`);
  }
printName('Cameron'); 
...
//CODE HERE
const printAllNames = (arrayNames)=>{
