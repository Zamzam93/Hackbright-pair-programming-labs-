...
/*
  ...
  Amy and Brittani were born in the same year. If they were, console.log 'Amy & Brittani were born in the same year'. If they were not, console.log 'Amy & Brittani were not born in the same year'
*/
...
if ((temperature >= 80) && (rain === true)) {
    ...
    console.log("one should wear a long sleeve or sweater");
