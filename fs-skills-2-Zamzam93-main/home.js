...
console.log(canWeDeliver(85825));
...
const canWeDeliverTwo = deliveryAreaZipCodes.includes('45575');
...
const objIndex =  deals.findIndex((obj=> obj.title));

deals[objIndex].title = '10% off';

console.log(deals[objIndex]);
...
const objindex =  deals.findIndex((obj=> obj.desc));
deals[objindex].desc = 'Applied to your entire order when you spend $30 or more';
